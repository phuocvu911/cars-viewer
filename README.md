...
## 404 Page
The 404 page is a simple soft landing page that shows the user that the page they are looking for does not exist. The user can click the button to go back to the home page.